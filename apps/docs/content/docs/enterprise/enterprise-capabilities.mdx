...
All packages used in Lucidity have been verified for license compliance using FOSSA, an automated license compliance and security scanning platform. This ensures that:
...
- **No Copyleft Issues**: No GPL or other copyleft licenses that would restrict your use of Lucidity
...
Lucidity only uses packages with the following approved license types:
...
For more information about Lucidity's licensing terms, see our [License](/enterprise/license) page.
