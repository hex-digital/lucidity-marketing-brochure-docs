...
const featureCards = [
  [
    ...
    'Your editorial team can log in and start working from day one. The Studio is organised around how your team actually works and is built for editors, not developers.',
    'var(--color-rose-dark)',
  ],
  [
    '02',
    'Visual Editing and live previews',
    'Editors see exactly what content will look like before publish, and stakeholders can review draft links without needing a Studio account.',
    'var(--color-blush-dark)',
  ],
  [
    '03',
    'Multisite and multilang from the ground up',
    'Run as many sites as you need from one codebase with independent content, language, and editorial workflows.',
    'var(--color-iris-dark)',
  ],
  [
    '04',
    'Security built in, not added on',
    'Password-protected environments, secure request handling, and CSP are part of the foundation from day one.',
    'var(--color-haze-dark)',
  ],
  [
    '05',
    'No single point of failure',
    'Consistent architecture and typed packages let any engineer onboard and maintain the platform safely.',
    'var(--color-mist-dark)',
  ],
  [
    '06',
    'Modular content blocks',
    'Composable, documented blocks let teams ship pages faster without repeating implementation work.',
    'var(--color-dew-dark)',
  ],
] as const;
...
const convinceCards = [
  [
    '01',
    '6 months of engineering time recovered.',
    'The infrastructure is already built. Multisite routing, cache invalidation, Studio configuration, and security are inherited on day one.',
    'var(--color-rose-dark)',
  ],
  [
    '02',
    'Day 1 onboard your editorial team.',
    'Your content team can log into a fully configured Studio straight away.',
    'var(--color-blush-dark)',
  ],
  [
    '03',
    'Unlimited sites, one engineering team.',
  ...
  [
    '04',
    'Low bus factor risk.',
    'Built on Sanity CMS, fully documented and typesafe so ownership is never isolated to one engineer.',
    'var(--color-haze-dark)',
  ],
  [
    '05',
    'Zero lock in.',
    'You own the source code from day one. Lucidity is a starting point, not a subscription platform.',
    'var(--color-mist-dark)',
  ],
  [
    '06',
    '1 year of updates included.',
    'Compatibility releases, bug fixes, and improvements are delivered via GitHub for year one.',
    'var(--color-dew-dark)',
  ],
] as const;
    ...
    <main className={styles.page}>
        ...
        <div className={styles.containerSplit}>
          <div className={styles.heroCopy}>
            ...
            <p>
              ...
              on Next.js and Sanity. Multisite, multi-lang, visual editing, caching, security
              and 40+ features, all from day one.
              <br />
              <br />
          ...
          <div className={styles.heroMedia}>
            <img
              src="http://localhost:3845/assets/2512387d80b6965b4e6d57294068895488a186ce.png"
              alt="Hero visual"
            />
          </div>
        </div>
      ...
      <section className={styles.section}>
        <div className={styles.containerCentered}>
          ...
          <p className={styles.centerCopy}>
            ...
            engineering teams at some of the world&apos;s leading organisations.
          </p>
          <div className={styles.stats}>
            <div>
              <strong>6+ months</strong>
              <span>head start on development work</span>
            </div>
            <div>
              <strong>40+</strong>
              <span>production features out of the box</span>
            </div>
            <div>
              <strong>Unlimited</strong>
              <span>sites from a single licence + codebase</span>
            </div>
          </div>
          <div className={styles.cardGrid}>
            {featureCards.map(([index, title, body, color]) => (
              <article key={title} className={styles.card}>
                <p className={styles.cardIndex} style={{ color }}>
                  {index}
                </p>
                <h3>{title}</h3>
                <p>{body}</p>
        ...
        <div className={styles.containerSplit}>
          <div>
            ...
            <p>
              ...
              content infrastructure is business-critical.
            </p>
            <Button href="#" variant="primary">
              Talk to sales
            </Button>
        ...
        <div className={styles.containerSplit}>
          ...
          <div className={styles.pathList}>
            {architectureRows.map(([name, description, dot]) => (
              <article key={name}>
                <h3>
                  <span className={styles.pathDot} style={{ background: dot }} />
                  {name}
                </h3>
                <p>{description}</p>
              </article>
      ...
      <section className={styles.section}>
        <div className={styles.containerSplit}>
          ...
          <div className={styles.pathList}>
            <article>
              <h3>Quick Start</h3>
              <p>The quickest route to getting a Lucidity project running locally.</p>
            </article>
            <article>
              <h3>Philosophy</h3>
              <p>Guiding principles for the development of Lucidity.</p>
            </article>
            <article>
              <h3>Enterprise</h3>
              <p>
                Guidance for teams preparing Lucidity for larger programs and enterprise
                delivery.
              </p>
            </article>
            <article>
              <h3>Structures</h3>
              <p>
                A high-level map of application structure, content model, and delivery flow.
              </p>
            </article>
          </div>
        </div>
      ...
      <section className={styles.sectionDark}>
        <div className={styles.containerCentered}>
          ...
          <div className={styles.faqList}>
            <article>
              <h3>Can&apos;t we just build it?</h3>
              <p>
                To create something like Lucidity yourself would take several hundred
                development hours and deep platform expertise.
              </p>
            </article>
            <article>
              <h3>Are we dependent on a third-party?</h3>
            </article>
            <article>
              <h3>What if we need to change things?</h3>
            </article>
            <article>
              <h3>Is there support if something goes wrong?</h3>
            </article>
          </div>
        </div>
      </section>
      ...
      <section className={styles.sectionDark}>
        <div className={styles.containerCentered}>
          ...
          <p className={styles.centerCopy}>
            Built by Hex Digital. Lucidity is the system we wished existed for enterprise
            content teams, then iterated into reality.
          </p>
        </div>
      </section>
