        ...
        <>
            ...
            <Wrapper className="items-center">
                <div className="flex flex-col gap-4 items-center relative z-4">
                    ...
                    <p className="text-center max-w-[600px] mt-6">
                        Lucidity is built on a modern, battle-tested stack, the same tools trusted by engineering teams at some of the world's leading organisations. No experimental dependencies, no niche frameworks. Just the right tools, configured properly.
                    </p>
                </div>
                <StatsRow stats={stats} />
                <ContentGrid content={featureCards} />
                <Button href="/" icon={true}>And so much more</Button>
            </Wrapper>
                ...
                <Wrapper>
                    <div className="grid md:grid-cols-2 gap-15">
                        <div className="flex flex-col gap-10">
                            ...
                            <div className="prose">
                                <p>Lucidity is built for engineering and product teams at organisations where content infrastructure is business-critical. Pricing is tailored to your team size and onboarding requirements.</p>
                                <p>
                                    <strong>What's included:</strong>
                                </p>
                                <ul>
                                    <li>The full source code is yours to own, modify and deploy indefinitely</li>
                        ...
                        <div className="flex flex-col gap-8">
                            {enterprisePoints && enterprisePoints.map((item, index) => (
                                <div key={index} className="flex flex-col gap-5 border-b-2 pb-8" style={{ borderColor: `var(${item.borderColor})` }}>
                ...
                <Wrapper>
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="prose max-w-[600px]">
                            <p>
                                For global organisations, multi-brand companies, and non-profits managing regional sites,
                                the challenge isn't building one good site. It's maintaining all of them without the
                                work multiplying every time you add another.
                            </p>

                            <p>
                                Most teams solve this the hard way. A new site means a new codebase, a new deployment,
                                and a new set of engineering problems to solve from scratch. Over time that compounds:
                                more repos to maintain, more inconsistencies to manage, and more engineering time spent
                                keeping everything in sync rather than improving the product.
                            </p>

                            <p>
                                Lucidity is built so that doesn't happen. Every site you run shares the same component
                                library, design system, and CMS tooling. Your editorial teams work independently in
                                their own content environment, with their own workflows and access controls, but the
                                underlying platform is one thing your engineering team maintains once.
                            </p>
                        ...
                        <img src="https://picsum.photos/1920/1080" alt="something here" className="rounded-[6px]"/>
                    </div>
                </Wrapper>
            </div>
            ...
            <Wrapper className="z-4">
                <div className="grid md:grid-cols-2 gap-15">
                    <div className="flex flex-col gap-10">
                        ...
                        <p>Lucidity is built on a modern, battle-tested stack — the same tools trusted by engineering teams at some of the world's leading organisations. No experimental dependencies, no niche frameworks. Just the right tools, configured properly.</p>
                    </div>

                    <div className="flex flex-col gap-8">
                        {techPoints && techPoints.map((item, index) => (
                            <div key={index} className="flex flex-col gap-5 border-b-2 pb-8" style={{ borderColor: `var(${item.borderColor})` }}>
                                <h4 className="text-post-subtitle-desktop">{ item.heading }</h4>
                                <p>{ item.content }</p>
                            </div>
            ...
            <Wrapper className="z-4">
                <div className="grid md:grid-cols-2 gap-15">
                    <div className="flex flex-col gap-10">
                        ...
                        <p>Lucidity’s architecture has been shaped through repeated builds for complex organisations. Each structural decision reflects what consistently worked, refined over time through real-world use. You’re not inheriting a clever idea, you’re inheriting a system that’s been continuously improved to handle challenges your team may not have even encountered yet.</p>
                    </div>

                    <div className="flex flex-col gap-8">
                        {architecturePoints && architecturePoints.map((item, index) => (
                            <div key={index} className="flex gap-5 pb-8">
                                <div className="text-neutral-70 max-w-[50px] w-full h-[50px] flex justify-center items-center rounded-full" style={{ backgroundColor: `var(${item.bulletColor})` }}>
                                    <svg width="14" height="10" viewBox="0 0 14 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M8.28 9.936L7.128 8.784L9.192 6.72L10.392 5.712L10.368 5.64L8.064 5.784H0V4.152H8.064L10.368 4.296L10.392 4.224L9.192 3.216L7.128 1.152L8.28 0L13.248 4.968L8.28 9.936Z" fill="currentColor"/>
                                    </svg>
                                </div>
                                <div>
                                    <h4 className="text-post-subtitle-desktop h-[50px] flex flex-col justify-center">{item.heading}</h4>
                                    <p>{item.content}</p>
                                </div>
                            </div>
                        ))}
            ...
            <Wrapper className="items-center ">
                <div className="flex flex-col gap-4 items-center z-4">
                    ...
                    <p className="text-center max-w-[600px] mt-6">
                        Lucidity isn't just a technical decision — it affects timelines, headcount, editorial velocity, and long-term maintainability. Here's what that looks like in concrete terms.
                    </p>
                ...
                <h3 className="text-page-title-s-desktop">Answers to likely concerns and questions</h3>
            ...
            <Wrapper className="z4">
                <div className="grid md:grid-cols-2 gap-15">
                    <div className="flex flex-col gap-10">
                        ...
                        <p>Lucidity is built on a modern, battle-tested stack, the same tools trusted by engineering teams at some of the world's leading organisations. No experimental dependencies, no niche frameworks. Just the right tools, configured properly.</p>
                        <Button href="#" variant="secondary" icon={true}>View the docs</Button>
                    </div>

                    <div className="flex flex-col gap-8">
                        {docsPoints && docsPoints.map((item, index) => (
                            <div key={index} className="flex gap-5 pb-8">
                                <div className="text-neutral-70 max-w-[50px] w-full h-[50px] flex justify-center items-center rounded-full" style={{ backgroundColor: `var(${item.bulletColor})` }}>
                                    <svg width="14" height="10" viewBox="0 0 14 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M8.28 9.936L7.128 8.784L9.192 6.72L10.392 5.712L10.368 5.64L8.064 5.784H0V4.152H8.064L10.368 4.296L10.392 4.224L9.192 3.216L7.128 1.152L8.28 0L13.248 4.968L8.28 9.936Z" fill="currentColor"/>
            ...
            <div className="bg-surface-dark relative z-4">
                <Wrapper className="items-center">
                    <div className="flex flex-col gap-4 items-center">
                        ...
                        <p className="text-center max-w-[600px] mt-6">
                            We'll take the time to understand your stack, your team, and your editorial requirements,  and give you an honest view of whether Lucidity is the right fit.
                        </p>
                        <Button href="/" className="mt-4">Talk to sales</Button>
                    </div>
                </Wrapper>
                ...
                <Wrapper className="items-center">
                    <div className="flex flex-col gap-4 items-center">
                        ...
                        <p className="text-center max-w-[600px] mt-6">
                            Not seeing what you need? <a href="https://www.hexdigital.com/contact" target="_blank" className="border-b-1">Talk to us directly.</a>
                        </p>
                    </div>
            ...
            <Wrapper className="items-center">
                <div className="flex flex-col gap-4 items-center">
                    ...
                    <p className="text-center max-w-[600px] mt-6">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed nec tristique nisi, condimentum tempus urna.
                    </p>
                </div>
