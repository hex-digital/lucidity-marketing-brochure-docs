import type { FAQItem } from '@/components/ui/FAQ/FAQ';
...
export const generalFaqs: FAQItem[] = [
  ...
  {
    key: crypto.randomUUID(),
    summary: 'Who is Lucidity.js for?',
    content: [
  ...
  {
    key: crypto.randomUUID(),
    summary: 'Who is Lucidity.js not for?',
    content: [
  ...
  {
    key: crypto.randomUUID(),
    summary: 'Why should we buy Lucidity.js instead of building our own Sanity setup?',
    content: [
  ...
  {
    key: crypto.randomUUID(),
    summary: 'Why buy Lucidity.js over a free starter kit?',
    content: [
  ...
  {
    key: crypto.randomUUID(),
    summary: 'How does Lucidity.js reduce delivery risk?',
    content: [
  ...
  {
    key: crypto.randomUUID(),
    summary: 'What features does Lucidity.js include out of the box?',
    content: [
  ...
  {
    key: crypto.randomUUID(),
    summary: 'Can I customise and change Lucidity.js?',
    content: [
  ...
  {
    key: crypto.randomUUID(),
    summary: 'What license does the code come with?',
    content: [
  ...
  {
    key: crypto.randomUUID(),
    summary: 'How many sites and languages can Lucidity.js support?',
    content: [
  ...
  {
    key: crypto.randomUUID(),
    summary: 'What support is available after purchase?',
    content: [
